...
CREATE TABLE "AuditLog" (
    ...
    "actorId" TEXT,
    "actorName" TEXT NOT NULL DEFAULT 'System Admin',
    "actorRole" "Role" NOT NULL DEFAULT 'ADMIN',
    "action" TEXT NOT NULL,
    "module" TEXT NOT NULL DEFAULT 'GENERAL',
    "targetType" TEXT NOT NULL DEFAULT 'System',
    "targetId" TEXT,
    "targetLabel" TEXT NOT NULL DEFAULT 'System Record',
    "details" TEXT NOT NULL DEFAULT 'Action recorded in system history',
    "changes" JSONB,
    "ipAddress" TEXT,
    "userAgent" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
