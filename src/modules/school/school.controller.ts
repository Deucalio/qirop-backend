...
export async function updateSchool(req: Request, res: Response): Promise<void> {
  const school = await schoolService.updateSchool(req.body);
  res.json(school);
}
...
export async function uploadLogo(req: Request, res: Response): Promise<void> {
  ...
  const school = await schoolService.updateLogo(path);
  res.json(school);
}
...
export async function updateSettings(req: Request, res: Response): Promise<void> {
  const settings = await schoolService.updateSettings(req.body.settings);
  res.json({ settings });
}
